...
/**
 * Activity that displays a list of users which can be added to a group.
 * <p>
 * This screen allows the creator or member of a group to select users
 * and add them to the current messaging group. It also provides navigation
 * to {@link MessagesActivity}.
 *
...
public class FriendsActivity extends AppCompatActivity {
    ...
    /**
     * Initializes the activity, retrieves group data from the intent,
     * and loads users for display.
     *
     * @param savedInstanceState previously saved state, if present
     */
    @Override
    ...
    /**
     * Retrieves all users from the backend API and displays them
     * in a {@link RecyclerView}.
     * <p>
     * Each user is assigned a profile image URL and can be added
     * to the current group by selecting them.
     */
    ...
    /**
     * Sends a request to the backend to add a specified user
