...
/**
 * AdminSettingsActivity provides administrative account settings functionality.
 * <p>
 * This activity allows an admin to:
 * <ul>
 *     <li>View account information</li>
 *     <li>Retrieve and display the admin's full name</li>
 *     <li>Log out of the application</li>
 *     <li>Remove the current profile picture</li>
 * </ul>
 * Navigation is handled using a bottom navigation bar, and
 * backend communication is performed with Retrofit.
 *
...
public class AdminSettingsActivity extends AppCompatActivity {
    ...
    /**
     * Initializes the activity UI, loads admin account details,
     * sets up navigation actions, and attaches button listeners.
     *
