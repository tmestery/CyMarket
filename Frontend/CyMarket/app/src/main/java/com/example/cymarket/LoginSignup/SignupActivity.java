 ...
 * Validates inputs, checks for existing usernames,
...
public class SignupActivity extends AppCompatActivity {
    ...
    /**
     * Initializes signup UI and click listeners.
     *
     * @param savedInstanceState Activity state info
     */
    @Override
    ...
    /**
     * Callback interface used for username validation.
     */
    ...
    /**
     * Sends signup request to backend to create a new user account.
     *
